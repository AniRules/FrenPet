...
## ⚠️ Disclaimer
**I do not own FrenPet.** This is an unofficial, personal-made wrapper. 
...
- To run it, download the Linux zip, extract it, right-click the `FrenPet` executable, and select **"Allow executing file as program"** in your file manager.
